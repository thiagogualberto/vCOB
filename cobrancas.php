...
if (isset($_SESSION['acessar_modulos'])){
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12">
                    ...
                    <div style="margin-top: 25px;">
                        ...
                        <button id="gera_carne" type="button" class="btn btn-large btn-success"> 
                            Gerar Carnê
                        </button>
                        <?php
                        }?>
    ...
    <!--                                <table style="width: 100%;">
                                    ...
                                    <table class="table table-striped" id="tbl_cobrancas">
                                        <thead>
                                            <tr>
                                                <th class="sorting" style="width: 29%"><b>Cliente</b></th>
                                                <th class="sorting" style="width: 14%"><b>Data Emissão</b></th>
                                                <th class="sorting" style="width: 15%"><b>Valor Emissao</b></th>
                                                <th class="sorting" style="width: 14%"><b>Data Vencimento</b></th>
                                                <th class="sorting" style="width: 14%"><b>Data Pagamento</b></th>
                                                <th class="sorting" style="width: 14%"><b>Valor Pagamento</b></th>
                                                <?php
                                                if ( (($_SESSION['acessar_modulos']["L00000120170808160005"]) == "S") ||
                                                     (($_SESSION['acessar_modulos']["L00000120170808160005"]) == "G") ){
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT tc.chave, tce.nome_fantasia, DATE_FORMAT(tc.dt_emissao,'%d/%m/%Y'), 
                                                    ...
                                                    where (tc.chave_empresa = '".$_SESSION["chave_empresa"]."') AND
                                                          (tce.nome_fantasia = '".$pesquisar."') AND (tce.cnpj <> '') AND (tce.ativo = 'S')
                                                    UNION
                                                    SELECT tc.chave, tce.nome_razaosocial, DATE_FORMAT(tc.dt_emissao,'%d/%m/%Y'), 
                                                    DATE_FORMAT(tc.dt_vencimento,'%d/%m/%Y'), format(tc.vl_emissao,2,'de_DE'),
                                                    DATE_FORMAT(tc.dt_pagamento,'%d/%m/%Y'), format(tc.vl_pago,2,'de_DE'),
                                                    tipo_baixa, linha
                                                    FROM tbl_cobranca AS tc 
                                                    INNER JOIN tbl_cliente_empresa AS tce on tc.chave_cliente = tce.chave
                                                    where (tc.chave_empresa = '".$_SESSION["chave_empresa"]."') AND
                                                          (tce.nome_razaosocial = '".$pesquisar."') AND (tce.cpf <> '') AND (tce.ativo = 'S')";
                                                ...
                                                <tr id="<?php echo $res["chave"]?>">
                                                    ...
                                                    if ( (($_SESSION['acessar_modulos']["L00000120170808160005"]) == "S") ||
                                                        ...
                                                        <?php
                                                            ...
                                                            <?php
                                                            if ($res["linha"] == ""){?>
                                                            <td><a title="Gerar Boleto" href="cobrancasBoletos.php?chave_cobranca=<?php echo $res["chave"];?>" target="_blank"><i class="fa fa-barcode fa-fw"></i></a></td>
                                                            <td></td>
                                                            <?php
                                                            }else{?>
                                                            <td><a class ="liquidar" data-toggle="modal" data-target="#exampleModal" title="Liquidar" href="#" style="color: red;"
                                                               data-id="<?php echo $res["chave"];?>" data-nm_fantasia="<?php echo $res["nome_fantasia"]?>" 
                                                            ...
                                                            <td><a title="Baixar Boleto" href="cobrancasBoletos.php?chave_cobranca=<?php echo $res["chave"];?>" target="_blank"><i class="fa fa-file-pdf-o fa-fw"></i></a></td>
                                                            <?php
                                                            }?>                                                        
                                                        <?php
                                                        }else{?>
                                                    ...
                                                    <div class="dataTables_paginate paging_bootstrap" style="text-align: center;">
                                                        <ul class="pagination">
                                                            ...
                                                            if ($pagina_anterior != 0){?>
                                                                <li><a href="index.php?pg=cobrancas&pagina=<?php echo $pagina_anterior;?>&filtrar=<?php echo $filtrou;?>&pesquisar_cobrancas_cliente=<?php echo $pesquisar;?>">← Anterior</a></li>
                                                            <?php
                                                            }else{?>
                                                            ...
                                                            for ($i=1;$i<=$num_paginas;$i++){
                                                                ...
                                                                if ($pagina == $i)  $estilo = "class=\"active\"";?>
                                                                    <li <?php echo $estilo;?> ><a href="index.php?pg=cobrancas&pagina=<?php echo $i;?>&filtrar=<?php echo $filtrou;?>&pesquisar_cobrancas_cliente=<?php echo $pesquisar;?>"><?php echo $i;?></a></li>
                                                            <?php
                                                            }?>
                                                            <?php
                                                            if($pagina_posterior <= $num_paginas){ ?>
                                                                <li class="next"><a href="index.php?pg=cobrancas&pagina=<?php echo $pagina_posterior;?>&filtrar=<?php echo $filtrou;?>&pesquisar_cobrancas_cliente=<?php echo $pesquisar;?>">Próximo → </a></li>
                                                            <?php }else{ ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="msg_dt" style="display: none">
                            <?php msg('4','Erro... Data de pagamento inválida.','','','',''); ?>
                        </div>
                        <div class="msg_vl" style="display: none">
                            <?php msg('4','Erro... Valor de pagamento inválido.','','','',''); ?>
                        </div>
                        <?php
                        form_inicio('formulario', 'POST', 'index.php?pg=cobrancasLiquidar',' ');
                        //form_inicio('formulario', 'POST', '',' ');
